...
def test_issue_40():
    runner = CliRunner()
    input = "\\g:BAD-GROUP,c:1326055296*3C\\!AIVDM,2,1,3,A,E7`B1:dW7oHth@@@@@@@@@@@@@@6@6R;mMQM@10888Qr8`8888888888,0*65"
    args = '--station=test'
    expected = "\\g:BAD-GROUP,c:1326055296,s:test*65\\!AIVDM,2,1,3,A,E7`B1:dW7oHth@@@@@@@@@@@@@@6@6R;mMQM@10888Qr8`8888888888,0*65"
...
def test_tagblock_group_with_extra_delimiters():
    ...
    assert tagblock['tagblock_sentence'] == 1
